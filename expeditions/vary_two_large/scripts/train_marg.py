...
### Config
retrain = True
name = lambda wc: f"2026-03-12_vary_c7_c9_pred_c{wc}_marg"
...
for pred_wc in (7, 9):
    ...
    columns = feature_names + [label_name(pred_wc)]
    ...
    ax_dist.set_ylabel(r"$\log P(\delta C_{" f"{pred_wc}" r"} \, | \, \textrm{dataset})$", fontsize=13)
